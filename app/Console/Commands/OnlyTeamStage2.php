...
class OnlyTeamStage2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'df:stage:tm2';
    ...
    {
        $model = League::whereIn('parse_id_v2',[2145,2146])->get();
                ...
                foreach ($ScheduleJson->matches as $el) {
                    ...
                    if(strcmp($el->stage,$data->match_stage)==0) {
                        ...
                        else
                        {
                             ...
                             if($data->current_matchday!=$el->season->currentMatchday && $el->status=="SCHEDULED" && $el->utcDate>=$current_dt)
                            {

                               League::where('parse_id_v2',$ScheduleJson->competition->id)->update(
                                        ['current_matchday' => $el->season->currentMatchday]
                                    );
                            }
