...
class LiveLeaguesUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'liveleague:update';
     ...
     * @var string
     */
    protected $description = 'Update live league every 15 min';
                ...
                foreach ($sc->matches as $el)
                {
                    ...
                    foreach ($sc_data as $live_sch)
                    {
                        ...
                        else
                        {
                            ...
                            error_log("[".$logEntry."]".$finalData,3, storage_path('logs/liveScoreFinished(current).log'));
    ...
    {
        $url = "http://18.195.230.229/api/league/".$league_id."/0/leaguePaginate";
