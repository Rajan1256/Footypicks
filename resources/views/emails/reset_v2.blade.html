...
<head>
    ...
    <title>FootyPicks Reset Email</title>
    <style type="text/css">
                ...
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td align="center" valign="top">
                            <table cellspacing="0" cellpadding="0" class="force-full-width"
                                ...
                                <tr>
                                    <td style="background-color:#3bcdb0;">
                                        <table cellspacing="0" cellpadding="0" class="force-full-width">
                                            <tr>
                                                <td style="font-size: 26px; font-weight: 600; color: #ffffff; text-align:center;"
                                                    class="mobile-spacing">
                                                    <div class="mobile-br">&nbsp;</div>
                                                    Your verification code: {{$access_code}}
                                                    <br/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color:#f0f0f0; font-size: 16px; text-align:center; padding-bottom:4px;">
                                                    Please use this verification to change your password from app.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table cellspacing="0" cellpadding="0" class="force-full-width">
                                <tr>
                                    <td style="padding-top: 15px; background-color:#3bcdb0;">
                                        <table cellspacing="0" cellpadding="0" bgcolor="#363636"
                                            ...
                                            <tr>
                                                <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                                                    © {{date("Y")}} FootyPicks. All Rights Reserved
                                                </td>
                                            </tr>
                                            <tr>
